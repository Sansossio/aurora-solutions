// Source https://github.com/nestjs/nest/issues/5676#issuecomment-749719792
...
type CorsOrigin = boolean | string | RegExp | (string | RegExp)[] | CustomOrigin
...
export class SocketIoAdapter extends AbstractWsAdapter {
  constructor (
    ...
    private readonly corsOrigin: CorsOrigin = true
  ) {
